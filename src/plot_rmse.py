...
plt.xlim(-2, nfreq+2)
plt.legend(loc=0)
plt.xlabel('frequency points', fontsize=16)
# plt.ylabel(r'$\rho$')
...
plt.xlim(-2, nfreq+2)
plt.xlabel('frequency points', fontsize=16)
plt.ylabel(r'$r_{\rm{RPCA}} - r_{\rm{PCA}}$', fontsize=16)
...
plt.ylabel('RMSE difference between RPCA and PCA [K]', fontsize=16)
