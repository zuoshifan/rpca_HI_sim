...
with h5py.File(in_dir+'corr_1000x21cm.hdf5', 'r') as f:
    cm_cm_corr = f['cm_cm'][:]
    tt_tt_corr = f['tt_tt'][:]

# may need to further tune mu
rpca = RPCA(tt_tt_corr, mu=1.0e3, lmbda=None)
...
# save data to file
with h5py.File(out_dir + 'decomp_1000x21cm.hdf5', 'w') as f:
