...
if conv_beam:
    ...
    # read the 1000 times larger convolved 21 cm map
    cm_name = map_dir + 'smooth_21cm_%d_700_800_256_1000x21cm.hdf5' % nside
...
with h5py.File(out_dir + 'corr_1000x21cm.hdf5', 'w') as f:
