...
plt.xlabel(r'$k_\parallel$ [$h$ Mpc${}^{-1}$]', fontsize=16)
plt.ylabel(r'$P_{21}(k_\parallel)$ [mK${}^2 h^{-1}$ Mpc]', fontsize=16)
...
# plt.legend(loc=0)
# plt.xlabel(r'$k_\parallel$ [$h$ Mpc${}^{-1}$]', fontsize=16)
# plt.ylabel(r'$P_{21}^{\mathrm{recovered}}(k_\parallel) / P_{21}^{\mathrm{input}}(k_\parallel)$', fontsize=16)
